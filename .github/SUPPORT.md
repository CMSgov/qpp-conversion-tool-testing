...
When [submitting a new issue or bug](https://github.com/CMSgov/qpp-conversion-tool-testing/issues/new) to this project, the maintainer will respond within 2 business days to the issue. Be sure that you have followed the guidelines set forth in the [CONTRIBUTING](/.github/CONTRIBUTING.md#submit-issue) document.
