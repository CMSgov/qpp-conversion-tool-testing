# Contributing to QPP Conversion Tool Testing

We would love for you to contribute to the QPP Conversion Tool Testing. As a contributor, here are the guidelines we would like you to follow:
...
If you have a question or problem, please [submit an issue](#submit-issue) to our [GitHub Repository](https://github.com/CMSgov/qpp-conversion-tool-testing).

## <a name="issue"></a> Found a Bug?
If you find a bug in the source code, you can help us by
[submitting an issue](#submit-issue) to our [GitHub Repository](https://github.com/CMSgov/qpp-conversion-tool-testing). Even better, you can
...
- version of qpp-conversion-tool-testing used (if any)
...
You can file new issues by filling out our [new issue form](https://github.com/CMSgov/qpp-conversion-tool-testing/issues/new).
...
* Search [GitHub](https://github.com/CMSgov/qpp-conversion-tool-testing/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate effort.
...
* In GitHub, send a pull request from your fork to `CMSgov/qpp-conversion-tool-testing:master`.
...
[github]: https://github.com/CMSgov/qpp-conversion-tool-testing
[dev-doc]: /README.md